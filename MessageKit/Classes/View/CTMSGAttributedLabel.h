...
@protocol CTMSGAttributedLabelDelegate;

/**
 *  CTMSGAttributedDataSource
 */
@protocol CTMSGAttributedDataSource <NSObject>
/**
...
/**
 *  CTMSGAttributedLabel
 */

@interface CTMSGAttributedLabel : UILabel <CTMSGAttributedDataSource, UIGestureRecognizerDelegate>
/**
 * 可以通过设置attributeDataSource或者attributeDictionary、highlightedAttributeDictionary来自定义不同文本的字体颜色
 */
@property(nonatomic, strong) id<CTMSGAttributedDataSource> attributeDataSource;
/**
...
/*!
 点击回调
 */
@property(nonatomic, weak) id<CTMSGAttributedLabelDelegate> delegate;
/**
 *  attributeDictionary
 */
...
// *  @param point point
// *
// *  @return CTMSGAttributedLabelClickedTextInfo
// */
//- (CTMSGAttributedLabelClickedTextInfo *)textInfoAtPoint:(CGPoint)point;
/**
 *  setTextHighlighted
 *
 ...
 */
@protocol CTMSGAttributedLabel <NSObject>
...
/*!
 CTMSGAttributedLabel点击回调
 */
@protocol CTMSGAttributedLabelDelegate <NSObject>
@optional
