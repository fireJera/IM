...
- (void)layoutSubviews {
    ...
    CGFloat delWidth = 24, delHeight = 24, delBottom = 20, delRight = 14;
...
- (void)p_commonInit {
    ...
    _emojiDeleteBtn = ({
        UIButton * button = [UIButton buttonWithType:UIButtonTypeCustom];
        [button setImage:[CTMSGUtilities imageForNameInBundle:@"ctmsg_chat_delEmoji_n"] forState:UIControlStateNormal];
