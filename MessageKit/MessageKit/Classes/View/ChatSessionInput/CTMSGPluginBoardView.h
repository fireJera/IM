...
@protocol CTMSGPluginBoardViewDelegate;

NS_ASSUME_NONNULL_BEGIN

@interface CTMSGPluginBoardView : UIView
...
/*!
 扩展功能板的点击回调
 */
@property(nonatomic, weak) id<CTMSGPluginBoardViewDelegate> pluginBoardDelegate;
...
/*!
 扩展功能板的点击回调
 */
@protocol CTMSGPluginBoardViewDelegate <NSObject>
