...
@interface CTMSGVideoPresentTransition ()
@property (assign, nonatomic) CTMSGVideoPresentTransitionType type;
@end

@implementation CTMSGVideoPresentTransition
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext{
    switch (_type) {
        case CTMSGVideoPresentTransitionPresent:
            [self presentAnimation:transitionContext];
            break;
            
        case CTMSGVideoPresentTransitionDismiss:
