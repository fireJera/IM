...
//#import "CTMSGPhotoView.h"
//#import "CTMSGPhotoSubViewCell.h"
//#import "CTMSGPhotoPreviewViewController.h"
//#import "CTMSGPhotoPreviewViewCell.h"
//#import "CTMSGVideoPreviewViewController.h"
//
//@interface CTMSGPresentTransition ()
//@property (assign, nonatomic) CTMSGPresentTransitionType type;
//@property (assign, nonatomic) CTMSGPresentTransitionVcType vcType;
//@property (strong, nonatomic) CTMSGPhotoView *photoView ;
//@end
//
//@implementation CTMSGPresentTransition
//
//+ (instancetype)transitionWithTransitionType:(CTMSGPresentTransitionType)type VcType:(CTMSGPresentTransitionVcType)vcType withPhotoView:(CTMSGPhotoView *)photoView  {
//    return [[self alloc] initWithTransitionType:type VcType:vcType withPhotoView:photoView];
//}
//
//- (instancetype)initWithTransitionType:(CTMSGPresentTransitionType)type VcType:(CTMSGPresentTransitionVcType)vcType withPhotoView:(CTMSGPhotoView *)photoView {
//    self = [super init];
//    if (self) {
...
//    switch (_type) {
//        case CTMSGPresentTransitionTypePresent:
//            [self presentAnimation:transitionContext];
//            break;
//            
//        case CTMSGPresentTransitionTypeDismiss:
//            [self dismissAnimation:transitionContext];
//            break;
//    }
//}
//- (void)presentAnim:(id<UIViewControllerContextTransitioning>)transitionContext Image:(UIImage *)image Model:(CTMSGPhotoModel *)model FromVC:(UIViewController *)fromVC ToVC:(UIViewController *)toVC cell:(CTMSGPhotoSubViewCell *)cell{
...
//    if (self.vcType == CTMSGPresentTransitionVcTypePhoto) {
...
//        }
//    }
//    CTMSGPhotoSubViewCell *cell = (CTMSGPhotoSubViewCell *)[collectionView cellForItemAtIndexPath:self.photoView.currentIndexPath];
//    CTMSGPhotoModel *model = cell.model;
...
//    }
//
//    CTMSGPhotoSubViewCell *cell = (CTMSGPhotoSubViewCell *)[collectionView cellForItemAtIndexPath:[NSIndexPath indexPathForItem:model.endCollectionIndex inSection:0]];
//    if (!tempView.image) {
