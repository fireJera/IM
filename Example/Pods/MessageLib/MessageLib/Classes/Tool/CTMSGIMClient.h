...
@property (nonatomic, copy) NSString * netUA;
...
//@property(nonatomic, strong) NSString *voiceAmrPath;
//@property(nonatomic, strong) NSString *voiceWavPath;
                  ...
                  pushContent:(nullable NSString *)pushContent
                     pushData:(nullable NSString *)pushData
                      success:(void (^ _Nullable )(long messageId))successBlock
                        error:(void (^ _Nullable )(CTMSGErrorCode nErrorCode, long messageId, NSError * _Nullable error))errorBlock;
...
- (CTMSGMessage *)sendMediaMessage:(CTMSGConversationType)conversationType
                       ...
                       pushContent:(nullable NSString *)pushContent
                          pushData:(nullable NSString *)pushData
                      uploadConfig:(nullable NSDictionary *)uploadConfig
                          progress:(void (^ _Nullable )(int progress, long messageId))progressBlock
                           success:(void (^ _Nullable )(long messageId))successBlock
                             error:(void (^ _Nullable )(CTMSGErrorCode errorCode, long messageId, NSError * _Nullable error))errorBlock
