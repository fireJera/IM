                  ...
                  pushContent:(nullable NSString *)pushContent
                     pushData:(nullable NSString *)pushData
                      success:(void (^)(long messageId))successBlock
                        error:(void (^)(CTMSGErrorCode nErrorCode, long messageId, NSError * _Nullable error))errorBlock;
...
- (CTMSGMessage *)sendMediaMessage:(CTMSGConversationType)conversationType
                      ...
                      uploadConfig:(nullable NSDictionary *)uploadConfig
                          progress:(void (^)(int progress, long messageId))progressBlock
                           success:(void (^)(long messageId))successBlock
                             error:(void (^)(CTMSGErrorCode errorCode, long messageId, NSError * _Nullable error))errorBlock
