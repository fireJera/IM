...
NSString * const CTMSGTypeStatusMessageTypeIdentifier =  @"CTMSG:TypStsMsg";

@implementation CTMSGTypingStatusMessage

+ (instancetype)messageWithType:(NSString *)type {
    CTMSGTypingStatusMessage * message = [[CTMSGTypingStatusMessage alloc] init];
    if (type) {
        message.typingContentType = type;
    }
    return message;
}
...
- (NSData *)encode {
    ...
    if (self.typingContentType) {
        [dataDict setObject:self.typingContentType forKey:@"typingContentType"];
    }
...
- (void)decodeWithData:(NSData *)data {
    if (data) {
        ...
        if (dictionary) {
            ...
            self.typingContentType = dictionary[@"typingContentType"];
...
+ (NSString *)getObjectName {
    return CTMSGTypeStatusMessageTypeIdentifier;
}
