//
//  CTMSGUploadMediaStatusListener.h
//  ChatMessageKit
//
...
@class CTMSGMessage, CTMSGMessageContent;

NS_ASSUME_NONNULL_BEGIN

@interface CTMSGUploadMediaStatusListener : NSObject

/*!
 上传的媒体文件消息的消息实体
 */
@property(nonatomic, strong) CTMSGMessage *currentMessage;
 ...
 */
@property(nonatomic, strong) void (^successBlock)(CTMSGMessageContent *content, long messageUId, NSDictionary * result);

/*!
 上传成功需要调用的block [errorCode:上传失败的错误码，非0整数]
 */
@property(nonatomic, strong) void (^errorBlock)(CTMSGErrorCode errorCode);
...
/*!
 ...
 @return                    媒体文件上传进度更新的MessageKit监听对象
 */
- (instancetype)initWithMessage:(CTMSGMessage *)message
                 uploadProgress:(void (^)(int progress))progressBlock
                  uploadSuccess:(void (^)(CTMSGMessageContent *content, long messageUId, NSDictionary * result))successBlock
                    uploadError:(void (^)(CTMSGErrorCode errorCode))errorBlock
