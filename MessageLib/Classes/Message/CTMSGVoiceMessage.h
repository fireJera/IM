...
//#define CTMSGVoiceMessageTypeIdentifier @"CTMSG:VICMsg"

NS_ASSUME_NONNULL_BEGIN

FOUNDATION_EXTERN NSString * const CTMSGVoiceMessageTypeIdentifier;
FOUNDATION_EXTERN NSString * const CTMSGVoiceMessageNetTypeIdentifier;
 ...
 */
+ (instancetype)messageWithAudio:(NSData *)audioData duration:(long)duration localURL:(NSString *)localURL;
