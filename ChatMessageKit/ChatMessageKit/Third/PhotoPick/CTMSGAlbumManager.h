...
typedef NS_ENUM(NSUInteger, CTMSGAlbumListScrollDirection) {
 ...
 */
@property (nonatomic, assign) CTMSGAlbumListScrollDirection scrollDirection;
 ...
 */
- (void)getAllAlbum:(void(^)(CTMSGAlbumModel *firstAlbum))firstAlbum albums:(void(^)(NSArray<CTMSGAlbumModel *> *albums))albums onlyFirst:(BOOL)onlyFirst;
 ...
 */
- (void)fetchPhotoForPHResult:(PHFetchResult *)result limitCount:(NSInteger)limiCount index:(NSInteger)index result:(void(^)(NSArray<CTMSGPhotoModel *> * photos, NSArray<CTMSGPhotoModel *> * videos, NSArray<CTMSGPhotoModel *> * objs))list;
...
/**
 ...
 @param index <#index description#>
 */
- (void)removeSelectdAtIndex:(NSInteger)index NS_UNAVAILABLE;
