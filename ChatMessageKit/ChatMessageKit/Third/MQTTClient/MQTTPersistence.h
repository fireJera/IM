...
@property (nonatomic, strong) NSNumber *incomingFlag;

/** The flag indicating if the flow element is retained*/
@property (nonatomic, strong) NSNumber *retainedFlag;

/** The MQTTCommandType of the flow element, might be MQTT_None for offline queueing */
@property (nonatomic, strong) NSNumber *commandType;

/** The MQTTQosLevel of the flow element */
@property (nonatomic, strong) NSNumber *qosLevel;
