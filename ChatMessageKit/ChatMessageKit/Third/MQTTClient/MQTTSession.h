...
*/
@property (nonatomic, strong) id<MQTTPersistence> persistence;
 ...
 */
@property (readonly, nonatomic, strong) NSNumber *serverKeepAlive;
...
/** topicAliasMaximum specifies the number of seconds after which a session should expire MQTT v5.0*/
@property (nonatomic, strong) NSDictionary <NSString *, NSString*> *userProperty;
 ...
 */
@property (nonatomic, strong) id <MQTTTransport> transport;
