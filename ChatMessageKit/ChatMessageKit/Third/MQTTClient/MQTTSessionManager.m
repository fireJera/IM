...
@property (nonatomic, strong) ReconnectTimer *reconnectTimer;
...
@property (nonatomic, strong) ForegroundReconnection *foregroundReconnection;
#endif
...
@property (nonatomic, strong) NSString *streamSSLLevel;

@property (nonatomic, strong) NSDictionary<NSString *, NSNumber *> *internalSubscriptions;
@property (nonatomic, strong) NSDictionary<NSString *, NSNumber *> *effectiveSubscriptions;
@property (nonatomic, strong) NSLock *subscriptionLock;
