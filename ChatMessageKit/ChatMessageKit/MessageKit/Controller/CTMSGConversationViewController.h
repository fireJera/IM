...
@class CTMSGPluginBoardView, CTMSGMessageModel, CTMSGMessageContent, CTMSGMessage, CTMSGUploadMediaStatusListener, CTMSGMessageBaseCell, CTMSGLocationMessage;
